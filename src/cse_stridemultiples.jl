...
@inline ArrayInterface.StrideIndex(sptr::OffsetPrecalc) = StrideIndex(getfield(sptr,:ptr))
...
@generated function offsetprecalc(p::AbstractStridedPointer{T,N,R,C,B,X}, ::Val{descript}) where {T,N,R,C,B,X,descript}
