  ...
  @time @testset "Grouped Strided Pointers" begin
    ...
    GC.@preserve A B C begin
      ...
      for ai ∈ fs, bi ∈ fs, ci ∈ fs
        ...
        Bt = bi ? B : (similar(B')');
        Ct = ci ? C : (similar(C')');
        spdw = LayoutPointers.DensePointerWrapper{(true,true)}(LayoutPointers.stridedpointer(At))
        gsp, pres = @inferred(LayoutPointers.grouped_strided_pointer((spdw,Bt,Ct), Val{(((1,1),(3,1)),((1,2),(2,1)),((2,2),(3,2)))}()))
        if ai === ci
        ...
        gsp2, pres2 = @inferred(LayoutPointers.grouped_strided_pointer((At,Btsw,Ct), Val{(((1,1),(3,1)),((1,2),(2,1)),((2,2),(3,2)))}()));
    ...
    sp_data_in, sp_tmp1 = LayoutPointers.stridedpointers(LayoutPointers.grouped_strided_pointer((data_in,tmp1), Val((((1,1),(2,1)),)))[1])
